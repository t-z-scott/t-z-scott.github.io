...
Similar to the [Vulnerability Management Lifecycle](/notes/01-vm-cycle), this process has three general phases: prepare, respond, follow-up.

# phase 1: preparation

This phase is essentially the e-discovery[^1] process.
