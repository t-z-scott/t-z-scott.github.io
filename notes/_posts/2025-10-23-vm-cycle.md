...
The vulnerability management lifecycle[^1] is similar to the [Incident Management Process](/notes/2025/10/23/im-process.html). This will be split into two parts: how I believe it should be done for individual projects, and the lifecycle that organizations use.
